...
# source://formtastic//lib/formtastic/engine.rb#2
module Formtastic
...
#
# source://formtastic//lib/formtastic/action_class_finder.rb#8
class Formtastic::ActionClassFinder < ::Formtastic::NamespacedClassFinder
  ...
  #
  # source://formtastic//lib/formtastic/action_class_finder.rb#11
  def initialize(builder); end

  # source://formtastic//lib/formtastic/action_class_finder.rb#15
  def class_name(as); end
end

# source://formtastic//lib/formtastic/actions.rb#3
module Formtastic::Actions
  extend ::ActiveSupport::Autoload
end

# source://formtastic//lib/formtastic/actions/base.rb#4
module Formtastic::Actions::Base
  include ::Formtastic::LocalizedString

  # source://formtastic//lib/formtastic/actions/base.rb#9
  def initialize(builder, template, object, object_name, method, options); end

  # source://formtastic//lib/formtastic/actions/base.rb#103
  def accesskey; end

  # Returns the value of attribute builder.
  #
  # source://formtastic//lib/formtastic/actions/base.rb#7
  def builder; end
  ...
  # source://formtastic//lib/formtastic/actions/base.rb#87
  def button_html; end

  # source://formtastic//lib/formtastic/actions/base.rb#91
  def button_html_from_options; end

  # source://formtastic//lib/formtastic/actions/base.rb#99
  def default_button_html; end

  # source://formtastic//lib/formtastic/actions/base.rb#50
  def default_wrapper_classes; end

  # source://formtastic//lib/formtastic/actions/base.rb#39
  def default_wrapper_html_options; end

  # source://formtastic//lib/formtastic/actions/base.rb#72
  def default_wrapper_id; end

  # source://formtastic//lib/formtastic/actions/base.rb#95
  ...
  #
  # source://formtastic//lib/formtastic/actions/base.rb#76
  ...
  # source://formtastic//lib/formtastic/actions/base.rb#80
  def text; end

  # @raise [NotImplementedError]
  #
  # source://formtastic//lib/formtastic/actions/base.rb#20
  def to_html; end

  # source://formtastic//lib/formtastic/actions/base.rb#24
  def wrapper(&block); end

  # source://formtastic//lib/formtastic/actions/base.rb#46
  def wrapper_class; end

  # source://formtastic//lib/formtastic/actions/base.rb#54
  def wrapper_classes_from_options; end

  # source://formtastic//lib/formtastic/actions/base.rb#31
  def wrapper_html_options; end

  # source://formtastic//lib/formtastic/actions/base.rb#35
  def wrapper_html_options_from_options; end

  # source://formtastic//lib/formtastic/actions/base.rb#64
  def wrapper_id; end

  # source://formtastic//lib/formtastic/actions/base.rb#68
  ...
  #
  # source://formtastic//lib/formtastic/actions/base.rb#114
  def check_supported_methods!; end

  # source://formtastic//lib/formtastic/actions/base.rb#118
  def i18n_key; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/actions/base.rb#131
  def new_or_persisted_object?; end

  # source://formtastic//lib/formtastic/actions/base.rb#135
  def sanitized_object_name; end

  # source://formtastic//lib/formtastic/actions/base.rb#123
...
#
# source://formtastic//lib/formtastic/actions/button_action.rb#46
class Formtastic::Actions::ButtonAction
  ...
  #
  # source://formtastic//lib/formtastic/actions/button_action.rb#61
  def to_html; end
end

# source://formtastic//lib/formtastic/actions/buttonish.rb#4
module Formtastic::Actions::Buttonish
  # source://formtastic//lib/formtastic/actions/buttonish.rb#10
  def extra_button_html_options; end

  # source://formtastic//lib/formtastic/actions/buttonish.rb#6
  def supported_methods; end
end
...
# @todo document i18n translation with :label (?)
#
# source://formtastic//lib/formtastic/actions/input_action.rb#49
class Formtastic::Actions::InputAction
  ...
  #
  # source://formtastic//lib/formtastic/actions/input_action.rb#64
  def to_html; end
end
...
#
# source://formtastic//lib/formtastic/actions/link_action.rb#57
class Formtastic::Actions::LinkAction
  ...
  # @see Formtastic::Helpers::ActionHelper#action
  #
  # source://formtastic//lib/formtastic/actions/link_action.rb#71
  def supported_methods; end

  # TODO reset_action class?
  #
  # source://formtastic//lib/formtastic/actions/link_action.rb#76
  def to_html; end

  # source://formtastic//lib/formtastic/actions/link_action.rb#82
  def url; end
end

# source://formtastic//lib/formtastic/deprecation.rb#5
...
# @private
#
# source://formtastic//lib/formtastic/engine.rb#5
class Formtastic::Engine < ::Rails::Engine; end

# source://formtastic//lib/formtastic/form_builder.rb#3
class Formtastic::FormBuilder < ::ActionView::Helpers::FormBuilder
  ...
  # source://formtastic//lib/formtastic/form_builder.rb#98
  def initialize(object_name, object, template, options); end

  # source://formtastic//lib/formtastic/form_builder.rb#15
  ...
  # source://formtastic//lib/formtastic/form_builder.rb#56
  def auto_index; end
  ...
  # source://formtastic//lib/formtastic/form_builder.rb#94
  ...
  # source://formtastic//lib/formtastic/form_builder.rb#54
  def template; end
  ...
  class << self
    ...
    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_action_namespaces; end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_action_namespaces=(new_value); end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_all_fields_required_by_default; end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_all_fields_required_by_default=(new_value); end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_collection_label_methods; end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_collection_label_methods=(new_value); end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_collection_value_methods; end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_collection_value_methods=(new_value); end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_custom_namespace; end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_custom_namespace=(new_value); end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_default_commit_button_accesskey; end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_default_commit_button_accesskey=(new_value); end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_default_error_list_class; end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_default_error_list_class=(new_value); end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_default_hint_class; end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_default_hint_class=(new_value); end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_default_inline_error_class; end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_default_inline_error_class=(new_value); end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_default_text_area_height; end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_default_text_area_height=(new_value); end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_default_text_area_width; end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_default_text_area_width=(new_value); end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_default_text_field_size; end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_default_text_field_size=(new_value); end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_escape_html_entities_in_hints_and_labels; end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_escape_html_entities_in_hints_and_labels=(new_value); end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_file_metadata_suffixes; end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_file_metadata_suffixes=(new_value); end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_file_methods; end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_file_methods=(new_value); end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_i18n_cache_lookups; end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_i18n_cache_lookups=(new_value); end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_i18n_localizer; end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_i18n_localizer=(new_value); end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_i18n_lookups_by_default; end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_i18n_lookups_by_default=(new_value); end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_include_blank_for_select_by_default; end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_include_blank_for_select_by_default=(new_value); end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_inline_errors; end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_inline_errors=(new_value); end
    ...
    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_label_str_method; end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_label_str_method=(new_value); end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_optional_string; end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_optional_string=(new_value); end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_perform_browser_validations; end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_perform_browser_validations=(new_value); end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_priority_countries; end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_priority_countries=(new_value); end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_priority_time_zones; end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_priority_time_zones=(new_value); end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_required_string; end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_required_string=(new_value); end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_skipped_columns; end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_skipped_columns=(new_value); end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_use_required_attribute; end

    # source://formtastic//lib/formtastic/form_builder.rb#15
    def __class_attr_use_required_attribute=(new_value); end
  end
end

# source://formtastic//lib/formtastic/helpers.rb#3
module Formtastic::Helpers; end

# source://formtastic//lib/formtastic/helpers/action_helper.rb#5
module Formtastic::Helpers::ActionHelper
  ...
  # @todo document i18n keys
  #
  # source://formtastic//lib/formtastic/helpers/action_helper.rb#79
  ...
  # @private
  #
  # source://formtastic//lib/formtastic/helpers/action_helper.rb#90
  ...
  #
  # source://formtastic//lib/formtastic/helpers/action_helper.rb#108
...
#
# source://formtastic//lib/formtastic/helpers/actions_helper.rb#54
module Formtastic::Helpers::ActionsHelper
  ...
  # @todo document i18n keys
  #
  # source://formtastic//lib/formtastic/helpers/actions_helper.rb#148
  def actions(*args, &block); end

  protected

  # source://formtastic//lib/formtastic/helpers/actions_helper.rb#163
  def default_actions; end
end

# @private
#
# source://formtastic//lib/formtastic/helpers/enum.rb#5
module Formtastic::Helpers::Enum
  # Returns the enum (if defined) for the given method
  #
  # source://formtastic//lib/formtastic/helpers/enum.rb#7
  def enum_for(method); end
end

# source://formtastic//lib/formtastic/helpers/errors_helper.rb#4
module Formtastic::Helpers::ErrorsHelper
  ...
  #   <% end %>
  #
  # source://formtastic//lib/formtastic/helpers/errors_helper.rb#42
  def semantic_errors(*args); end

  protected

  # source://formtastic//lib/formtastic/helpers/errors_helper.rb#62
  def error_keys(method, options); end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/helpers/errors_helper.rb#72
  def has_errors?(method, options); end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/helpers/errors_helper.rb#77
  def render_inline_errors?; end
end

# source://formtastic//lib/formtastic/helpers/errors_helper.rb#9
Formtastic::Helpers::ErrorsHelper::INLINE_ERROR_TYPES = T.let(T.unsafe(nil), Array)

# @private
#
# source://formtastic//lib/formtastic/helpers/fieldset_wrapper.rb#5
module Formtastic::Helpers::FieldsetWrapper
  ...
  #
  # source://formtastic//lib/formtastic/helpers/fieldset_wrapper.rb#25
  def field_set_and_list_wrapping(*args, &block); end

  # source://formtastic//lib/formtastic/helpers/fieldset_wrapper.rb#52
  ...
  #
  # source://formtastic//lib/formtastic/helpers/fieldset_wrapper.rb#62
  def parent_child_index(parent); end
end

# @private
#
# source://formtastic//lib/formtastic/helpers/file_column_detection.rb#5
module Formtastic::Helpers::FileColumnDetection
  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/helpers/file_column_detection.rb#7
...
#
# source://formtastic//lib/formtastic/helpers/form_helper.rb#50
module Formtastic::Helpers::FormHelper
  # source://formtastic//lib/formtastic/helpers/form_helper.rb#55
  def builder; end

  # source://formtastic//lib/formtastic/helpers/form_helper.rb#55
  def builder=(val); end

  # source://formtastic//lib/formtastic/helpers/form_helper.rb#60
  def default_form_class; end

  # source://formtastic//lib/formtastic/helpers/form_helper.rb#60
  def default_form_class=(val); end

  # source://formtastic//lib/formtastic/helpers/form_helper.rb#65
  def default_form_model_class_proc; end

  # source://formtastic//lib/formtastic/helpers/form_helper.rb#65
  def default_form_model_class_proc=(val); end

  # source://formtastic//lib/formtastic/helpers/form_helper.rb#71
  ...
  #
  # source://formtastic//lib/formtastic/helpers/form_helper.rb#183
  ...
  #
  # source://formtastic//lib/formtastic/helpers/form_helper.rb#154
  def semantic_form_for(record_or_name_or_array, *args, &proc); end

  protected

  # source://formtastic//lib/formtastic/helpers/form_helper.rb#195
...
#
# source://formtastic//lib/formtastic/helpers/input_helper.rb#39
module Formtastic::Helpers::InputHelper
  ...
  #
  # source://formtastic//lib/formtastic/helpers/input_helper.rb#233
  ...
  #
  # source://formtastic//lib/formtastic/helpers/input_helper.rb#307
  ...
  #
  # source://formtastic//lib/formtastic/helpers/input_helper.rb#255
  ...
  #
  # source://formtastic//lib/formtastic/helpers/input_helper.rb#339
...
#
# source://formtastic//lib/formtastic/helpers/inputs_helper.rb#47
module Formtastic::Helpers::InputsHelper
  ...
  # @param *args [Hash] a customizable set of options
  #
  # source://formtastic//lib/formtastic/helpers/inputs_helper.rb#280
  ...
  # generated input.
  #
  # source://formtastic//lib/formtastic/helpers/inputs_helper.rb#338
  def association_columns(*by_associations); end

  # Collects content columns (non-relation columns) for the current form object class.
  #
  # source://formtastic//lib/formtastic/helpers/inputs_helper.rb#364
  def content_columns; end

  # source://formtastic//lib/formtastic/helpers/inputs_helper.rb#311
  def default_columns_for_object; end

  # @private
  #
  # source://formtastic//lib/formtastic/helpers/inputs_helper.rb#405
  def field_set_title_from_args(*args); end

  # source://formtastic//lib/formtastic/helpers/inputs_helper.rb#318
  def fieldset_contents_from_column_list(columns); end

  # Collects all foreign key columns
  #
  # source://formtastic//lib/formtastic/helpers/inputs_helper.rb#355
  ...
  #
  # source://formtastic//lib/formtastic/helpers/inputs_helper.rb#376
  def inputs_for_nested_attributes(*args, &block); end
end

# @private
#
# source://formtastic//lib/formtastic/helpers/reflection.rb#5
module Formtastic::Helpers::Reflection
  # @private
  #
  # source://formtastic//lib/formtastic/helpers/reflection.rb#16
  def association_macro_for_method(method); end

  # @private
  #
  # source://formtastic//lib/formtastic/helpers/reflection.rb#21
  def association_primary_key_for_method(method); end

  # If an association method is passed in (f.input :author) try to find the
  # reflection object.
  #
  # source://formtastic//lib/formtastic/helpers/reflection.rb#8
  def reflection_for(method); end
end

# @private
#
# source://formtastic//lib/formtastic/html_attributes.rb#4
module Formtastic::HtmlAttributes
  ...
  #
  # source://formtastic//lib/formtastic/html_attributes.rb#6
  def dom_id_namespace; end

  protected

  # source://formtastic//lib/formtastic/html_attributes.rb#19
  def humanized_attribute_name(method); end
end

# @private
#
# source://formtastic//lib/formtastic/i18n.rb#6
module Formtastic::I18n
  class << self
    # source://formtastic//lib/formtastic/i18n.rb#29
    def t(*args); end

    # source://formtastic//lib/formtastic/i18n.rb#22
...
# source://formtastic//lib/formtastic/i18n.rb#10
...
#
# source://formtastic//lib/formtastic/input_class_finder.rb#8
class Formtastic::InputClassFinder < ::Formtastic::NamespacedClassFinder
  ...
  #
  # source://formtastic//lib/formtastic/input_class_finder.rb#11
  def initialize(builder); end

  # source://formtastic//lib/formtastic/input_class_finder.rb#15
  def class_name(as); end
end

# source://formtastic//lib/formtastic/inputs.rb#3
module Formtastic::Inputs
  extend ::ActiveSupport::Autoload
end

# source://formtastic//lib/formtastic/inputs/base.rb#4
module Formtastic::Inputs::Base
  ...
  # source://formtastic//lib/formtastic/inputs/base.rb#8
  def initialize(builder, template, object, object_name, method, options); end

  # Returns the value of attribute builder.
  #
  # source://formtastic//lib/formtastic/inputs/base.rb#6
  def builder; end
  ...
  # @raise [ArgumentError]
  #
  # source://formtastic//lib/formtastic/inputs/base.rb#38
  ...
  #
  # source://formtastic//lib/formtastic/inputs/base.rb#23
  def warn_and_correct_option!(old_option_name, new_option_name); end

  # Usefull for deprecating options.
  #
  # source://formtastic//lib/formtastic/inputs/base.rb#31
  def warn_deprecated_option!(old_option_name, instructions); end
end

# source://formtastic//lib/formtastic/inputs/base/associations.rb#5
module Formtastic::Inputs::Base::Associations
  include ::Formtastic::Helpers::Reflection

  # :belongs_to, etc
  #
  # source://formtastic//lib/formtastic/inputs/base/associations.rb#9
  def association; end

  # source://formtastic//lib/formtastic/inputs/base/associations.rb#25
  def association_primary_key; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/base/associations.rb#17
  def belongs_to?; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/base/associations.rb#21
  def has_many?; end

  # source://formtastic//lib/formtastic/inputs/base/associations.rb#13
  def reflection; end
end

# source://formtastic//lib/formtastic/inputs/base/choices.rb#5
module Formtastic::Inputs::Base::Choices
  # source://formtastic//lib/formtastic/inputs/base/choices.rb#43
  def choice_html(choice); end

  # source://formtastic//lib/formtastic/inputs/base/choices.rb#59
  def choice_html_options(choice); end

  # source://formtastic//lib/formtastic/inputs/base/choices.rb#71
  def choice_html_safe_value(choice); end

  # source://formtastic//lib/formtastic/inputs/base/choices.rb#75
  def choice_input_dom_id(choice); end

  # source://formtastic//lib/formtastic/inputs/base/choices.rb#47
  def choice_label(choice); end

  # source://formtastic//lib/formtastic/inputs/base/choices.rb#55
  def choice_value(choice); end

  # source://formtastic//lib/formtastic/inputs/base/choices.rb#29
  def choice_wrapping(html_options, &block); end

  # source://formtastic//lib/formtastic/inputs/base/choices.rb#36
  def choice_wrapping_html_options(choice); end

  # source://formtastic//lib/formtastic/inputs/base/choices.rb#18
  def choices_group_wrapping(&block); end

  # source://formtastic//lib/formtastic/inputs/base/choices.rb#25
  def choices_group_wrapping_html_options; end

  # source://formtastic//lib/formtastic/inputs/base/choices.rb#7
  def choices_wrapping(&block); end

  # source://formtastic//lib/formtastic/inputs/base/choices.rb#14
  def choices_wrapping_html_options; end

  # source://formtastic//lib/formtastic/inputs/base/choices.rb#67
  def custom_choice_html_options(choice); end

  # source://formtastic//lib/formtastic/inputs/base/choices.rb#63
  ...
  #
  # source://formtastic//lib/formtastic/inputs/base/choices.rb#102
  def label_html_options; end

  # source://formtastic//lib/formtastic/inputs/base/choices.rb#89
  def legend_html; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/base/choices.rb#85
  def value_as_class?; end
end

# source://formtastic//lib/formtastic/inputs/base/collections.rb#5
module Formtastic::Inputs::Base::Collections
  # source://formtastic//lib/formtastic/inputs/base/collections.rb#50
  def collection; end

  # source://formtastic//lib/formtastic/inputs/base/collections.rb#131
  def collection_for_boolean; end

  # source://formtastic//lib/formtastic/inputs/base/collections.rb#74
  ...
  #
  # source://formtastic//lib/formtastic/inputs/base/collections.rb#114
  def collection_from_enum; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/base/collections.rb#127
  def collection_from_enum?; end

  # source://formtastic//lib/formtastic/inputs/base/collections.rb#62
  def collection_from_options; end

  # source://formtastic//lib/formtastic/inputs/base/collections.rb#23
  def label_and_value_method; end

  # source://formtastic//lib/formtastic/inputs/base/collections.rb#27
  def label_and_value_method_from_collection(_collection); end

  # source://formtastic//lib/formtastic/inputs/base/collections.rb#7
  def label_method; end

  # source://formtastic//lib/formtastic/inputs/base/collections.rb#11
  def label_method_from_options; end

  # source://formtastic//lib/formtastic/inputs/base/collections.rb#46
  def raw_collection; end

  # source://formtastic//lib/formtastic/inputs/base/collections.rb#140
  ...
  #
  # source://formtastic//lib/formtastic/inputs/base/collections.rb#150
  def send_or_call_or_object(duck, object); end

  # source://formtastic//lib/formtastic/inputs/base/collections.rb#15
  def value_method; end

  # source://formtastic//lib/formtastic/inputs/base/collections.rb#19
  def value_method_from_options; end
end

# source://formtastic//lib/formtastic/inputs/base/database.rb#5
module Formtastic::Inputs::Base::Database
  # source://formtastic//lib/formtastic/inputs/base/database.rb#7
  def column; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/base/database.rb#13
  def column?; end
end

# source://formtastic//lib/formtastic/inputs/base/datetime_pickerish.rb#5
module Formtastic::Inputs::Base::DatetimePickerish
  include ::Formtastic::Inputs::Base::Placeholder

  # source://formtastic//lib/formtastic/inputs/base/datetime_pickerish.rb#52
  def default_maxlength; end

  # @raise [NotImplementedError]
  #
  # source://formtastic//lib/formtastic/inputs/base/datetime_pickerish.rb#12
  def default_size; end

  # source://formtastic//lib/formtastic/inputs/base/datetime_pickerish.rb#56
  def default_step; end

  # source://formtastic//lib/formtastic/inputs/base/datetime_pickerish.rb#24
  def extra_input_html_options; end

  # @raise [NotImplementedError]
  #
  # source://formtastic//lib/formtastic/inputs/base/datetime_pickerish.rb#8
  def html_input_type; end

  # source://formtastic//lib/formtastic/inputs/base/datetime_pickerish.rb#20
  def input_html_options; end

  # source://formtastic//lib/formtastic/inputs/base/datetime_pickerish.rb#46
  def maxlength; end

  # source://formtastic//lib/formtastic/inputs/base/datetime_pickerish.rb#34
  def size; end

  # source://formtastic//lib/formtastic/inputs/base/datetime_pickerish.rb#40
  def step; end

  # @raise [NotImplementedError]
  #
  # source://formtastic//lib/formtastic/inputs/base/datetime_pickerish.rb#16
  def value; end

  protected

  # source://formtastic//lib/formtastic/inputs/base/datetime_pickerish.rb#62
  def step_from_macro(sym); end
end

# source://formtastic//lib/formtastic/inputs/base/errors.rb#5
module Formtastic::Inputs::Base::Errors
  # source://formtastic//lib/formtastic/inputs/base/errors.rb#25
  def error_first_html; end

  # source://formtastic//lib/formtastic/inputs/base/errors.rb#7
  def error_html; end

  # source://formtastic//lib/formtastic/inputs/base/errors.rb#48
  def error_keys; end

  # source://formtastic//lib/formtastic/inputs/base/errors.rb#16
  def error_list_html; end

  # source://formtastic//lib/formtastic/inputs/base/errors.rb#30
  def error_none_html; end

  # source://formtastic//lib/formtastic/inputs/base/errors.rb#11
  def error_sentence_html; end

  # source://formtastic//lib/formtastic/inputs/base/errors.rb#38
  def errors; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/base/errors.rb#34
  def errors?; end
end

# source://formtastic//lib/formtastic/inputs/base/fileish.rb#5
module Formtastic::Inputs::Base::Fileish
  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/base/fileish.rb#7
  def file?; end
end

# source://formtastic//lib/formtastic/inputs/base/hints.rb#5
module Formtastic::Inputs::Base::Hints
  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/base/hints.rb#17
  def hint?; end

  # source://formtastic//lib/formtastic/inputs/base/hints.rb#7
  def hint_html; end

  # source://formtastic//lib/formtastic/inputs/base/hints.rb#21
  def hint_text; end

  # source://formtastic//lib/formtastic/inputs/base/hints.rb#25
  def hint_text_from_options; end
end

# source://formtastic//lib/formtastic/inputs/base/html.rb#5
module Formtastic::Inputs::Base::Html
  # source://formtastic//lib/formtastic/inputs/base/html.rb#31
  def dom_id; end

  # source://formtastic//lib/formtastic/inputs/base/html.rb#40
  def dom_index; end

  # source://formtastic//lib/formtastic/inputs/base/html.rb#22
  def input_html_options; end
  ...
  # @raise [NotImplementedError]
  #
  # source://formtastic//lib/formtastic/inputs/base/html.rb#18
  def to_html; end
end

# source://formtastic//lib/formtastic/inputs/base/labelling.rb#5
module Formtastic::Inputs::Base::Labelling
  include ::Formtastic::LocalizedString

  # source://formtastic//lib/formtastic/inputs/base/labelling.rb#37
  def label_from_options; end

  # source://formtastic//lib/formtastic/inputs/base/labelling.rb#9
  def label_html; end

  # source://formtastic//lib/formtastic/inputs/base/labelling.rb#13
  def label_html_options; end

  # source://formtastic//lib/formtastic/inputs/base/labelling.rb#20
  def label_text; end

  # source://formtastic//lib/formtastic/inputs/base/labelling.rb#41
  def localized_label; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/base/labelling.rb#45
  def render_label?; end

  # source://formtastic//lib/formtastic/inputs/base/labelling.rb#29
  def requirement_text; end

  # TODO: why does this need to be memoized in order to make the inputs_spec tests pass?
  #
  # source://formtastic//lib/formtastic/inputs/base/labelling.rb#25
  def requirement_text_or_proc; end
end

# source://formtastic//lib/formtastic/inputs/base/naming.rb#5
module Formtastic::Inputs::Base::Naming
  # source://formtastic//lib/formtastic/inputs/base/naming.rb#7
  def as; end

  # source://formtastic//lib/formtastic/inputs/base/naming.rb#19
  def attributized_method_name; end

  # source://formtastic//lib/formtastic/inputs/base/naming.rb#23
  def humanized_method_name; end

  # source://formtastic//lib/formtastic/inputs/base/naming.rb#36
  def input_name; end

  # source://formtastic//lib/formtastic/inputs/base/naming.rb#15
  def sanitized_method_name; end

  # source://formtastic//lib/formtastic/inputs/base/naming.rb#11
  def sanitized_object_name; end
end

# source://formtastic//lib/formtastic/inputs/base/numeric.rb#5
module Formtastic::Inputs::Base::Numeric
  # source://formtastic//lib/formtastic/inputs/base/numeric.rb#39
  def in_option; end

  # source://formtastic//lib/formtastic/inputs/base/numeric.rb#6
  def input_html_options; end

  # source://formtastic//lib/formtastic/inputs/base/numeric.rb#34
  def max_option; end

  # source://formtastic//lib/formtastic/inputs/base/numeric.rb#29
  def min_option; end

  # source://formtastic//lib/formtastic/inputs/base/numeric.rb#24
  def step_option; end

  # source://formtastic//lib/formtastic/inputs/base/numeric.rb#43
  def wrapper_html_options; end
end

# source://formtastic//lib/formtastic/inputs/base/options.rb#5
module Formtastic::Inputs::Base::Options
  # source://formtastic//lib/formtastic/inputs/base/options.rb#11
  def formtastic_options; end

  # source://formtastic//lib/formtastic/inputs/base/options.rb#7
  def input_options; end
end

# source://formtastic//lib/formtastic/inputs/base/placeholder.rb#5
module Formtastic::Inputs::Base::Placeholder
  # source://formtastic//lib/formtastic/inputs/base/placeholder.rb#7
  def input_html_options; end

  # source://formtastic//lib/formtastic/inputs/base/placeholder.rb#11
  def placeholder_text; end
end

# source://formtastic//lib/formtastic/inputs/base/stringish.rb#5
module Formtastic::Inputs::Base::Stringish
  # Overrides standard `input_html_options` to provide a `maxlength` and `size` attribute.
  #
  # source://formtastic//lib/formtastic/inputs/base/stringish.rb#16
  def input_html_options; end

  # source://formtastic//lib/formtastic/inputs/base/stringish.rb#27
  def maxlength; end

  # source://formtastic//lib/formtastic/inputs/base/stringish.rb#23
  def size; end

  # @abstract Override this method in your input class to describe how the input should render itself.
  #
  # source://formtastic//lib/formtastic/inputs/base/stringish.rb#8
  def to_html; end

  # source://formtastic//lib/formtastic/inputs/base/stringish.rb#31
  def wrapper_html_options; end
end
...
#
# source://formtastic//lib/formtastic/inputs/base/timeish.rb#95
module Formtastic::Inputs::Base::Timeish
  # source://formtastic//lib/formtastic/inputs/base/timeish.rb#123
  def date_fragments; end

  # source://formtastic//lib/formtastic/inputs/base/timeish.rb#127
  def default_date_fragments; end

  # source://formtastic//lib/formtastic/inputs/base/timeish.rb#150
  def fragment_id(fragment); end

  # source://formtastic//lib/formtastic/inputs/base/timeish.rb#168
  def fragment_input_html(fragment); end

  # source://formtastic//lib/formtastic/inputs/base/timeish.rb#139
  def fragment_label(fragment); end

  # source://formtastic//lib/formtastic/inputs/base/timeish.rb#158
  def fragment_label_html(fragment); end

  # source://formtastic//lib/formtastic/inputs/base/timeish.rb#154
  def fragment_name(fragment); end

  # source://formtastic//lib/formtastic/inputs/base/timeish.rb#173
  def fragment_prefix; end

  # source://formtastic//lib/formtastic/inputs/base/timeish.rb#131
  def fragment_wrapping(&block); end

  # source://formtastic//lib/formtastic/inputs/base/timeish.rb#135
  def fragment_wrapping_html_options; end

  # source://formtastic//lib/formtastic/inputs/base/timeish.rb#115
  def fragments; end

  # source://formtastic//lib/formtastic/inputs/base/timeish.rb#225
  def fragments_inner_wrapping(&block); end

  # source://formtastic//lib/formtastic/inputs/base/timeish.rb#214
  def fragments_label; end

  # source://formtastic//lib/formtastic/inputs/base/timeish.rb#203
  def fragments_wrapping(&block); end

  # source://formtastic//lib/formtastic/inputs/base/timeish.rb#210
  def fragments_wrapping_html_options; end

  # source://formtastic//lib/formtastic/inputs/base/timeish.rb#235
  def hidden_field_name(fragment); end

  # source://formtastic//lib/formtastic/inputs/base/timeish.rb#231
  def hidden_fragments; end

  # source://formtastic//lib/formtastic/inputs/base/timeish.rb#194
  ...
  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/base/timeish.rb#182
  def include_blank?; end

  # source://formtastic//lib/formtastic/inputs/base/timeish.rb#190
  def position(fragment); end

  # source://formtastic//lib/formtastic/inputs/base/timeish.rb#186
  def positions; end

  # source://formtastic//lib/formtastic/inputs/base/timeish.rb#119
  def time_fragments; end

  # source://formtastic//lib/formtastic/inputs/base/timeish.rb#97
  def to_html; end

  # source://formtastic//lib/formtastic/inputs/base/timeish.rb#163
  def value; end
end

# source://formtastic//lib/formtastic/inputs/base/validations.rb#5
module Formtastic::Inputs::Base::Validations
  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/base/validations.rb#179
  def autofocus?; end

  # source://formtastic//lib/formtastic/inputs/base/validations.rb#185
  def column_limit; end

  # source://formtastic//lib/formtastic/inputs/base/validations.rb#189
  def limit; end

  # source://formtastic//lib/formtastic/inputs/base/validations.rb#167
  def not_required_through_negated_validation!; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/base/validations.rb#163
  def not_required_through_negated_validation?; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/base/validations.rb#175
  def optional?; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/base/validations.rb#193
  def readonly?; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/base/validations.rb#197
  def readonly_attribute?; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/base/validations.rb#205
  def readonly_from_options?; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/base/validations.rb#131
  def required?; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/base/validations.rb#159
  def required_attribute?; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/base/validations.rb#171
  def responds_to_global_required?; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/base/validations.rb#116
  def validation_integer_only?; end

  # source://formtastic//lib/formtastic/inputs/base/validations.rb#55
  def validation_limit; end

  # Prefer :less_than_or_equal_to over :less_than, for no particular reason.
  #
  # source://formtastic//lib/formtastic/inputs/base/validations.rb#87
  def validation_max; end

  # Prefer :greater_than_or_equal_to over :greater_than, for no particular reason.
  #
  # source://formtastic//lib/formtastic/inputs/base/validations.rb#67
  def validation_min; end

  # source://formtastic//lib/formtastic/inputs/base/validations.rb#105
  def validation_step; end

  # source://formtastic//lib/formtastic/inputs/base/validations.rb#25
  def validations; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/base/validations.rb#127
  def validations?; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/base/validations.rb#35
  ...
  #
  # source://formtastic//lib/formtastic/inputs/base/validations.rb#213
...
class Formtastic::Inputs::Base::Validations::IndeterminableMaximumAttributeError < ::ArgumentError
  # source://formtastic//lib/formtastic/inputs/base/validations.rb#17
  def message; end
end
...
module Formtastic::Inputs::Base::Wrapping
  ...
  #
  # source://formtastic//lib/formtastic/inputs/base/wrapping.rb#10
  def input_wrapping(&block); end

  # source://formtastic//lib/formtastic/inputs/base/wrapping.rb#32
  def wrapper_classes; end

  # source://formtastic//lib/formtastic/inputs/base/wrapping.rb#28
  def wrapper_classes_raw; end

  # source://formtastic//lib/formtastic/inputs/base/wrapping.rb#44
  def wrapper_dom_id; end

  # source://formtastic//lib/formtastic/inputs/base/wrapping.rb#17
  def wrapper_html_options; end

  # source://formtastic//lib/formtastic/inputs/base/wrapping.rb#24
...
#
# source://formtastic//lib/formtastic/inputs/boolean_input.rb#33
class Formtastic::Inputs::BooleanInput
  ...
  # source://formtastic//lib/formtastic/inputs/boolean_input.rb#66
  def check_box_html; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/boolean_input.rb#94
  def checked?; end

  # source://formtastic//lib/formtastic/inputs/boolean_input.rb#74
  def checked_value; end

  # source://formtastic//lib/formtastic/inputs/boolean_input.rb#43
  def hidden_field_html; end

  # source://formtastic//lib/formtastic/inputs/boolean_input.rb#82
  def input_html_options; end

  # source://formtastic//lib/formtastic/inputs/boolean_input.rb#86
  def input_html_options_name; end

  # source://formtastic//lib/formtastic/inputs/boolean_input.rb#55
  def label_html_options; end

  # source://formtastic//lib/formtastic/inputs/boolean_input.rb#62
  def label_text_with_embedded_checkbox; end

  # source://formtastic//lib/formtastic/inputs/boolean_input.rb#47
  def label_with_nested_checkbox; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/boolean_input.rb#78
  def responds_to_global_required?; end

  # source://formtastic//lib/formtastic/inputs/boolean_input.rb#36
  def to_html; end

  # source://formtastic//lib/formtastic/inputs/boolean_input.rb#70
  ...
  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/boolean_input.rb#100
...
#
# source://formtastic//lib/formtastic/inputs/check_boxes_input.rb#68
class Formtastic::Inputs::CheckBoxesInput
  ...
  #
  # source://formtastic//lib/formtastic/inputs/check_boxes_input.rb#73
  def initialize(*args); end

  # source://formtastic//lib/formtastic/inputs/check_boxes_input.rb#117
  def check_box_with_hidden_input(choice); end

  # source://formtastic//lib/formtastic/inputs/check_boxes_input.rb#127
  def check_box_without_hidden_input(choice); end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/check_boxes_input.rb#141
  def checked?(value); end

  # source://formtastic//lib/formtastic/inputs/check_boxes_input.rb#94
  def choice_html(choice); end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/check_boxes_input.rb#145
  def disabled?(value); end

  # source://formtastic//lib/formtastic/inputs/check_boxes_input.rb#153
  def disabled_values; end

  # source://formtastic//lib/formtastic/inputs/check_boxes_input.rb#137
  def extra_html_options(choice); end

  # source://formtastic//lib/formtastic/inputs/check_boxes_input.rb#102
  def hidden_field_for_all; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/check_boxes_input.rb#113
  def hidden_fields_for_every?; end

  # source://formtastic//lib/formtastic/inputs/check_boxes_input.rb#163
  def input_name; end

  # source://formtastic//lib/formtastic/inputs/check_boxes_input.rb#149
  def selected_values; end

  # source://formtastic//lib/formtastic/inputs/check_boxes_input.rb#78
  def to_html; end

  # source://formtastic//lib/formtastic/inputs/check_boxes_input.rb#159
  def unchecked_value; end

  protected

  # source://formtastic//lib/formtastic/inputs/check_boxes_input.rb#173
  def checkbox_input(choice); end

  # source://formtastic//lib/formtastic/inputs/check_boxes_input.rb#181
...
# @see Formtastic::Helpers::InputsHelper#input InputsHelper#input for full documentation of all possible options.
#
# source://formtastic//lib/formtastic/inputs/color_input.rb#29
class Formtastic::Inputs::ColorInput
  ...
  # source://formtastic//lib/formtastic/inputs/color_input.rb#34
  def to_html; end
end
...
# @see Formtastic::Helpers::InputsHelper#input InputsHelper#input for full documentation of all possible options.
#
# source://formtastic//lib/formtastic/inputs/country_input.rb#68
class Formtastic::Inputs::CountryInput
  ...
  # source://formtastic//lib/formtastic/inputs/country_input.rb#81
  def priority_countries; end

  # @raise [CountrySelectPluginMissing]
  #
  # source://formtastic//lib/formtastic/inputs/country_input.rb#73
  def to_html; end
end

# source://formtastic//lib/formtastic/inputs/country_input.rb#71
...
#
# source://formtastic//lib/formtastic/inputs/datalist_input.rb#14
class Formtastic::Inputs::DatalistInput
  ...
  # source://formtastic//lib/formtastic/inputs/datalist_input.rb#36
  def data_list_html; end

  # source://formtastic//lib/formtastic/inputs/datalist_input.rb#32
  def html_id_of_datalist; end

  # source://formtastic//lib/formtastic/inputs/datalist_input.rb#28
  def input_html_options; end

  # source://formtastic//lib/formtastic/inputs/datalist_input.rb#19
  def to_html; end
end
...
# @see Formtastic::Helpers::InputsHelper#input InputsHelper#input for full documentation of all possible options.
#
# source://formtastic//lib/formtastic/inputs/date_picker_input.rb#71
class Formtastic::Inputs::DatePickerInput
  ...
  # source://formtastic//lib/formtastic/inputs/date_picker_input.rb#80
  def default_size; end

  # source://formtastic//lib/formtastic/inputs/date_picker_input.rb#76
  def html_input_type; end

  # source://formtastic//lib/formtastic/inputs/date_picker_input.rb#84
  def value; end
end
...
#
# source://formtastic//lib/formtastic/inputs/date_select_input.rb#7
class Formtastic::Inputs::DateSelectInput
  ...
  # source://formtastic//lib/formtastic/inputs/date_select_input.rb#26
  def fragment_value(fragment); end

  # source://formtastic//lib/formtastic/inputs/date_select_input.rb#16
  def hidden_date_fragments; end

  # source://formtastic//lib/formtastic/inputs/date_select_input.rb#20
  def hidden_fragments; end

  # We don't want hour and minute fragments on a date input
  #
  # source://formtastic//lib/formtastic/inputs/date_select_input.rb#12
  def time_fragments; end
end
...
# @see Formtastic::Helpers::InputsHelper#input InputsHelper#input for full documentation of all possible options.
#
# source://formtastic//lib/formtastic/inputs/datetime_picker_input.rb#79
class Formtastic::Inputs::DatetimePickerInput
  ...
  # source://formtastic//lib/formtastic/inputs/datetime_picker_input.rb#89
  def default_size; end

  # source://formtastic//lib/formtastic/inputs/datetime_picker_input.rb#84
  def html_input_type; end

  # source://formtastic//lib/formtastic/inputs/datetime_picker_input.rb#93
  def value; end
end
...
# @see Formtastic::Inputs::Base::Timeish Timeish module for documentation of date, time and datetime input options.
#
# source://formtastic//lib/formtastic/inputs/datetime_select_input.rb#8
...
# @see Formtastic::Helpers::InputsHelper#input InputsHelper#input for full documentation of all possible options.
#
# source://formtastic//lib/formtastic/inputs/email_input.rb#29
class Formtastic::Inputs::EmailInput
  ...
  # source://formtastic//lib/formtastic/inputs/email_input.rb#34
  def to_html; end
end
...
# @see Formtastic::Helpers::InputsHelper#input InputsHelper#input for full documentation of all possible options.
#
# source://formtastic//lib/formtastic/inputs/file_input.rb#33
class Formtastic::Inputs::FileInput
  ...
  # source://formtastic//lib/formtastic/inputs/file_input.rb#35
  def to_html; end
end
...
# @see Formtastic::Helpers::InputsHelper#input InputsHelper#input for full documentation of all possible options.
#
# source://formtastic//lib/formtastic/inputs/hidden_input.rb#32
class Formtastic::Inputs::HiddenInput
  ...
  # source://formtastic//lib/formtastic/inputs/hidden_input.rb#45
  def error_html; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/hidden_input.rb#49
  def errors?; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/hidden_input.rb#57
  def hint?; end

  # source://formtastic//lib/formtastic/inputs/hidden_input.rb#53
  def hint_html; end

  # source://formtastic//lib/formtastic/inputs/hidden_input.rb#35
  def input_html_options; end

  # source://formtastic//lib/formtastic/inputs/hidden_input.rb#39
  def to_html; end
end
...
#
# source://formtastic//lib/formtastic/inputs/number_input.rb#71
class Formtastic::Inputs::NumberInput
  ...
  # source://formtastic//lib/formtastic/inputs/number_input.rb#83
  def step_option; end

  # source://formtastic//lib/formtastic/inputs/number_input.rb#76
  def to_html; end
end
...
# @see Formtastic::Helpers::InputsHelper#input InputsHelper#input for full documentation of all possible options.
#
# source://formtastic//lib/formtastic/inputs/password_input.rb#29
class Formtastic::Inputs::PasswordInput
  ...
  # source://formtastic//lib/formtastic/inputs/password_input.rb#34
  def to_html; end
end
...
# @see Formtastic::Helpers::InputsHelper#input InputsHelper#input for full documentation of all possible options.
#
# source://formtastic//lib/formtastic/inputs/phone_input.rb#29
class Formtastic::Inputs::PhoneInput
  ...
  # source://formtastic//lib/formtastic/inputs/phone_input.rb#34
  def to_html; end
end
...
#
# source://formtastic//lib/formtastic/inputs/radio_input.rb#128
class Formtastic::Inputs::RadioInput
  ...
  # source://formtastic//lib/formtastic/inputs/radio_input.rb#148
  def choice_html(choice); end

  # Override to remove the for attribute since this isn't associated with any element, as it's
  # nested inside the legend.
  #
  # source://formtastic//lib/formtastic/inputs/radio_input.rb#158
  def label_html_options; end

  # source://formtastic//lib/formtastic/inputs/radio_input.rb#133
  def to_html; end
end
...
# @see http://api.rubyonrails.org/classes/ActiveModel/Validations/HelperMethods.html#method-i-validates_numericality_of Rails' Numericality validation documentation
#
# source://formtastic//lib/formtastic/inputs/range_input.rb#71
class Formtastic::Inputs::RangeInput
  ...
  # source://formtastic//lib/formtastic/inputs/range_input.rb#86
  def max_option; end

  # source://formtastic//lib/formtastic/inputs/range_input.rb#82
  def min_option; end

  # source://formtastic//lib/formtastic/inputs/range_input.rb#90
  def step_option; end

  # source://formtastic//lib/formtastic/inputs/range_input.rb#75
  def to_html; end
end
...
# @see Formtastic::Helpers::InputsHelper#input InputsHelper#input for full documentation of all possible options.
#
# source://formtastic//lib/formtastic/inputs/search_input.rb#28
class Formtastic::Inputs::SearchInput
  ...
  # source://formtastic//lib/formtastic/inputs/search_input.rb#33
  def to_html; end
end
...
# @todo Do/can we support the per-item HTML options like RadioInput?
#
# source://formtastic//lib/formtastic/inputs/select_input.rb#157
class Formtastic::Inputs::SelectInput
  ...
  #
  # source://formtastic//lib/formtastic/inputs/select_input.rb#161
  def initialize(*args); end

  # source://formtastic//lib/formtastic/inputs/select_input.rb#197
  def extra_input_html_options; end

  # source://formtastic//lib/formtastic/inputs/select_input.rb#177
  def include_blank; end

  # source://formtastic//lib/formtastic/inputs/select_input.rb#193
  def input_html_options; end

  # source://formtastic//lib/formtastic/inputs/select_input.rb#206
  def input_html_options_name; end

  # source://formtastic//lib/formtastic/inputs/select_input.rb#214
  def input_html_options_name_multiple; end

  # source://formtastic//lib/formtastic/inputs/select_input.rb#189
  def input_options; end

  # source://formtastic//lib/formtastic/inputs/select_input.rb#185
  def label_html_options; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/select_input.rb#226
  def multiple?; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/select_input.rb#218
  def multiple_by_association?; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/select_input.rb#222
  def multiple_by_options?; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/select_input.rb#181
  def prompt?; end

  # source://formtastic//lib/formtastic/inputs/select_input.rb#173
  def select_html; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/select_input.rb#230
  def single?; end

  # source://formtastic//lib/formtastic/inputs/select_input.rb#166
  def to_html; end
end
...
# @see Formtastic::Helpers::InputsHelper#input InputsHelper#input for full documentation of all possible options.
#
# source://formtastic//lib/formtastic/inputs/string_input.rb#30
...
# @see Formtastic::Helpers::InputsHelper#input InputsHelper#input for full documentation of all possible options.
#
# source://formtastic//lib/formtastic/inputs/text_input.rb#29
class Formtastic::Inputs::TextInput
  ...
  # source://formtastic//lib/formtastic/inputs/text_input.rb#33
  def input_html_options; end

  # source://formtastic//lib/formtastic/inputs/text_input.rb#40
  def to_html; end
end
...
# @see Formtastic::Helpers::InputsHelper#input InputsHelper#input for full documentation of all possible options.
#
# source://formtastic//lib/formtastic/inputs/time_picker_input.rb#72
class Formtastic::Inputs::TimePickerInput
  ...
  # source://formtastic//lib/formtastic/inputs/time_picker_input.rb#81
  def default_size; end

  # source://formtastic//lib/formtastic/inputs/time_picker_input.rb#94
  def default_step; end

  # source://formtastic//lib/formtastic/inputs/time_picker_input.rb#77
  def html_input_type; end

  # source://formtastic//lib/formtastic/inputs/time_picker_input.rb#85
  def value; end
end
...
# @see Formtastic::Inputs::Base::Timeish Timeish module for documentation of date, time and datetime input options.
#
# source://formtastic//lib/formtastic/inputs/time_select_input.rb#10
class Formtastic::Inputs::TimeSelectInput
  ...
  # source://formtastic//lib/formtastic/inputs/time_select_input.rb#23
  def fragment_value(fragment); end

  # we don't want year / month / day fragments if :ignore_date => true
  #
  # source://formtastic//lib/formtastic/inputs/time_select_input.rb#15
  def fragments; end

  # source://formtastic//lib/formtastic/inputs/time_select_input.rb#27
  def hidden_fragments; end

  # source://formtastic//lib/formtastic/inputs/time_select_input.rb#19
...
# @see Formtastic::Helpers::InputsHelper#input InputsHelper#input for full documentation of all possible options.
#
# source://formtastic//lib/formtastic/inputs/time_zone_input.rb#44
class Formtastic::Inputs::TimeZoneInput
  ...
  # source://formtastic//lib/formtastic/inputs/time_zone_input.rb#54
  def priority_zones; end

  # source://formtastic//lib/formtastic/inputs/time_zone_input.rb#47
  def to_html; end
end
...
# @see Formtastic::Helpers::InputsHelper#input InputsHelper#input for full documentation of all possible options.
#
# source://formtastic//lib/formtastic/inputs/url_input.rb#29
class Formtastic::Inputs::UrlInput
  ...
  # source://formtastic//lib/formtastic/inputs/url_input.rb#34
  def to_html; end
end

# source://formtastic//lib/formtastic/localized_string.rb#3
module Formtastic::LocalizedString
  # source://formtastic//lib/formtastic/localized_string.rb#5
  def model_name; end
  ...
  # @private
  #
  # source://formtastic//lib/formtastic/localized_string.rb#11
...
class Formtastic::Localizer
  ...
  #
  # source://formtastic//lib/formtastic/localizer.rb#56
  def initialize(current_builder); end

  # Returns the value of attribute builder.
  #
  # source://formtastic//lib/formtastic/localizer.rb#50
  def builder; end
  ...
  # @private
  #
  # source://formtastic//lib/formtastic/localizer.rb#60
  ...
  # @private
  #
  # source://formtastic//lib/formtastic/localizer.rb#134
  def escape_html_entities(string); end

  # source://formtastic//lib/formtastic/localizer.rb#146
  def i18n_cache_lookups; end

  # source://formtastic//lib/formtastic/localizer.rb#142
  def i18n_lookups_by_default; end

  # source://formtastic//lib/formtastic/localizer.rb#118
  def normalize_model_name(name); end

  class << self
    # source://formtastic//lib/formtastic/localizer.rb#52
    def cache; end
  end
end
...
class Formtastic::Localizer::Cache
  # source://formtastic//lib/formtastic/localizer.rb#41
  def cache; end

  # source://formtastic//lib/formtastic/localizer.rb#45
  def clear!; end

  # source://formtastic//lib/formtastic/localizer.rb#29
  def get(key); end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/localizer.rb#33
  def has_key?(key); end

  # source://formtastic//lib/formtastic/localizer.rb#37
...
class Formtastic::NamespacedClassFinder
  ...
  #
  # source://formtastic//lib/formtastic/namespaced_class_finder.rb#41
  ...
  #
  # source://formtastic//lib/formtastic/namespaced_class_finder.rb#68
  def class_name(as); end
  ...
  #
  # source://formtastic//lib/formtastic/namespaced_class_finder.rb#53
  def find(as); end

  # @private
  #
  # source://formtastic//lib/formtastic/namespaced_class_finder.rb#26
  def namespaces; end

  # source://formtastic//lib/formtastic/namespaced_class_finder.rb#57
  def resolve(as); end
  ...
  #
  # source://formtastic//lib/formtastic/namespaced_class_finder.rb#89
  ...
  #
  # source://formtastic//lib/formtastic/namespaced_class_finder.rb#80
  ...
  class << self
    ...
    # @return [Boolean]
    #
    # source://formtastic//lib/formtastic/namespaced_class_finder.rb#32
