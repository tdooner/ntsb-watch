...
class User
  ...
  module GeneratedAssociationMethods
    sig { returns(T::Array[T.untyped]) }
    def watch_condition_ids; end

    sig { params(ids: T::Array[T.untyped]).returns(T::Array[T.untyped]) }
    def watch_condition_ids=(ids); end

    # This method is created by ActiveRecord on the `User` class because it declared `has_many :watch_conditions`.
    # 🔗 [Rails guide for `has_many` association](https://guides.rubyonrails.org/association_basics.html#the-has-many-association)
    sig { returns(::WatchCondition::PrivateCollectionProxy) }
    def watch_conditions; end

    sig { params(value: T::Enumerable[::WatchCondition]).void }
    def watch_conditions=(value); end
  end
